...
namespace my_books_test
{
    public class PublishersControllerTest
    {
        ...
        [Test,Order(2)]
        public void HTTPGET_GetPublisherById_RetunrsOk_Test()
        {
            int publishersId = 1;
            IActionResult actionResult = publishersController.GetPublisherById(publishersId);
            Assert.That(actionResult, Is.TypeOf<OkObjectResult>());
        ...
        [Test,Order(3)]
        public void HTTPGET_GetPublisherById_RetunrsNotFound_Test()
        {
            int publishersId = 99;
            IActionResult actionResult = publishersController.GetPublisherById(publishersId);
